        ...
        <>
            ...
            <Form onSubmit={handleSubmit} style={formStyle}>
                ...
                <Label htmlFor="statelocation">State (2-letter abbr)</Label>
                    <Input name="state" pattern="|AL|AK|AS|AZ|AR|CA|CO|CT|DE|DC|FM|FL|GA|GU|HI|ID|IL|IN|IA|KS|KY|LA|ME|MH|MD|MA|MI|MN|MS|MO|MT|NE|NV|NH|NJ|NM|NY|NC|ND|MP|OH|OK|OR|PW|PA|PR|RI|SC|SD|TN|TX|UT|VT|VI|VA|WA|WV|WI|WY|" placeholder="State" value={statelocation} onChange={(e) => setStateLocation(e.target.value)} />
                </FormGroup>
                <FormGroup>
